...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var gaugeData = [{
      ...
      delta: { reference: 2, increasing: { color: "darkblue" } },
      gauge: {
        axis: { range: [null, 10] },
        bar: { color: "#162872" },
        bgcolor: "#ffffff",
        ...
        bordercolor: "#bcbcc4",
        steps: [
          { range: [0, 2], color: "#eaf2df" },
          { range: [2, 4], color: "#abdfca" },
          { range: [4, 6], color: "#a4b5cd" },
          { range: [6, 8], color: "#57668e" },
          { range: [8, 10], color: "#344880" }
        ],
      }
    }];
    ...
    var gaugeLayout = { 
      width: "col-md-4", height: 450, margin: { t: 0, b: 0 } 
    };
